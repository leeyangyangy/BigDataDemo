...
public class ParamVersionServiceImpl extends ServiceImpl<ParamVersionMapper, ParamVersion> implements ParamVersionService {
    ...
    public boolean enableVersion(Long id) {
        ...
        try {
            spcStatService.regenerateForNewVersion(id, TriggerSourceConstants.VERSION_SWITCH);
        } catch (Exception e) {
    ...
    public boolean updateVersion(Long id, ParamVersion updated) {
        ...
        if (existing == null) throw new ResourceNotFoundException("参数版本", id);
        ...
        try {
            spcStatService.regenerateForNewVersion(id, TriggerSourceConstants.VERSION_UPDATE);
        } catch (Exception e) {
